...
def run_simulation():
    ...
    stats = {
        agent.name: {
            ...
            "civil_wins": 0,
            "impostor_wins": 0,
            "votes_cast_against_impostor": 0, # Précision
            "votes_cast_against_civil": 0,    # Confusion
            "manipulation_score": 0           # Manipulation
        } 
        for agent in AGENTS
    }
    ...
    print(f"{headers[0]:<15} | {headers[1]:<10} | {headers[2]:<10} | {headers[3]:<12} | {headers[4]}")
    print("-" * 75)
